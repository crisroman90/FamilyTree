...
/**
 * Family member class allows for the construction of a single family member.
...
public class FamilyMember implements Serializable{
    ...
    public String toString() {
        ...
        //a maiden name and it uses the gender symbols to identify them
        String s = null;
    ...
    //regex to match for a valid name
    ...
    public void setMaidenName(String maidenName) {
        if (maidenName.trim().matches(nameRegex)) {
            if (this.gender == Gender.FEMALE){
                ...
                throw new IllegalArgumentException("Maiden name is only for females");
            }
